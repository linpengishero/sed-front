<template>
  ...
  <div class="common-layout">
        ...
        <el-row>
          <el-col :span="24">
            <p>To obtain the treasure map, you need to complete tasks 1 to 3 at minimum. 
               You will receive an additional 200 MCW token reward for each friend invited.</p>
          </el-col>
        </el-row>

        <el-row style="margin-top:1.5rem; margin-bottom:2rem;">
          <el-col :span="11">
            Start date 2024.07.01 15:00:00
          </el-col>
    ...
    <el-collapse v-model="activeName" accordion>
      ...
      <el-collapse-item name="1">
        <template #title>
            <el-row class="head-row" :gutter="5">
                <el-col :span="2">
                    <img style="width:100%; margin-top:2.3rem;" src="../assets/images/mediaIcons/x.png"/>
                </el-col>
        ...
        <div class="el-collapse-content-xxl" v-if="currentMember && currentMember.join_tw == 0">
            <el-row>
             <el-col :span="12">
                <p>
                  Click "Go Join" to follow MetaCollabWin's official Twitter, fill in your Twitter username, and verify.</p>
                <el-button type="primary">Go Join</el-button>
            </el-col>
             <el-col :span="12">
              <el-input
                    v-model="valid.tw"
      ...
      <el-collapse-item  name="2">
        <template #title>
            <el-row class="head-row" :gutter="5">
                <el-col :span="2">
                    <img style="width:100%; margin-top:2.3rem;" src="../assets/images/mediaIcons/telegram.png"/>
                </el-col>
                <el-col :span="22"><p>Join the @Metacollabwin on Telegram</p></el-col>
      ...
      <el-collapse-item  name="3">
        <template #title>
            <el-row class="head-row" :gutter="5">
                <el-col :span="2">
                    <img style="width:100%; margin-top:2.3rem;" src="../assets/images/mediaIcons/discord.png"/>
                </el-col>
                <el-col :span="22"><p>Join the Discord Server</p></el-col>
      ...
      <el-collapse-item  name="4">
        <template #title>
            <el-row class="head-row" :gutter="5">
                ...
                <el-col :span="22"><p>Invite friends</p></el-col>

            </el-row>
        </template>

        <div class="el-collapse-content-xxl" v-if="currentMember">
            <el-row>
             <el-col :span="24">
  ...
  <el-row class="mint">
    ...
    <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
      ...
      <el-footer>
        <p style="text-align:center; color:white;">Copyright © 2024 Metacollabwin. All Rights Reserved</p>
      </el-footer>
